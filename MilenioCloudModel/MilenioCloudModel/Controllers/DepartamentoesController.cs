...
namespace MilenioCloudModel.Controllers
{
    public class DepartamentoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Codigo_Id,Dane_Id,Nombre,Latitud,Longitud")] Departamento departamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Codigo_Id,Dane_Id,Nombre,Latitud,Longitud")] Departamento departamento)
        {
            if (ModelState.IsValid)
            {
